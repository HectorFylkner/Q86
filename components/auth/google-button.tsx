...
export function GoogleButton({ next }: { next?: string }) {
  ...
  return (
    <>
      ...
      <Link
        href={href}
        className="flex w-full items-center justify-center gap-2.5 rounded-control border border-grid bg-surface px-4 py-2.5 text-sm font-medium text-ink transition-colors hover:border-graphite/50"
      >
